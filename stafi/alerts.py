...
#######################################
# ALERTS
@cpu_metric.set_alert(Stdout(), sleep=0)
...
@memory_metric.set_alert(Stdout(), sleep=0)
...
@disk_metric.set_alert(Stdout(), sleep=0)
...
@node_peers_metric.set_alert(Stdout(), sleep=0)
...
@node_version_metric.set_alert(Stdout(), sleep=0)
...
@node_block_height_metric.set_alert(Stdout(), sleep=0)
...
@node_online_metric.set_alert(Stdout(), sleep=0)
